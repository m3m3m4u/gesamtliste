...
export default async function Home() {
  ...
  {/* Hinweis entfernt */}
        <div className="flex flex-col gap-4">
          ...
          {authed && <a href="/meldungen" className="inline-block bg-slate-600 hover:bg-slate-700 text-white px-8 py-3 rounded-md shadow transition-colors">Meldungen (intern)</a>}
          {authed && (
