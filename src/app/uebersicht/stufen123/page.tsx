...
// Präfixe für Stufen 1, 2, 3
const KLASSEN_PREFIXES = ['A0', 'B0', 'C0', 'A1'];

export default function Stufen123Page() {
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      {!loading && !error && filteredKlassen.map(klasse => (
        <div key={klasse} className="border rounded bg-white shadow-sm">
          <div className="bg-amber-100 px-4 py-2 font-semibold border-b flex justify-between items-center">
